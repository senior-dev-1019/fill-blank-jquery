jQuery.fn.jDropWords = function(options) {
  ...
  function dropElement(srcElt, targetElt) {
    ...
    for (var i = 0; i < targetElt[0].children.length; i++) {
      if(i > 0){
        console.log(targetElt[0].children[i].children[1].children[0]);
        targetElt[0].children[i].children[1].children[0].click();
        $(targetElt[0].children[i]).remove();
      }
    }
